...
def compile_shaders():
    ...
    """
    # vertex_color - przechodzi z wyzej do shader fragemnt
...
def render(time):
    ...
    V_matrix = glm.lookAt(
        glm.vec3(10.0, 0.0, 10.0), # gdzie sie znajduje
        glm.vec3(5.0, 5.0, 0.0),  # gdzie sie patrzy
        glm.vec3(0.0, -1.0, 0.0)  # gdzie jest góra
    )
